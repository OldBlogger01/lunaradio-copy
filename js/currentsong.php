...
if (isset($_POST['ownurl']) && $_POST['ownurl'] != ""):
	echo utf8_encode(htmlentities(html_entity_decode(ownsongtitleURL($_POST['ownurl']), ENT_QUOTES | ENT_HTML5,"ISO-8859-1")));
elseif (isset($_POST['url']) && $_POST['url'] != ""):
	echo utf8_encode(htmlentities(html_entity_decode(shoutcast1($_POST['url']), ENT_QUOTES | ENT_HTML5,"ISO-8859-1")));
else:
	echo "";
endif;
